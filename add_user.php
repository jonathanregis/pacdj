						...
						<div class="panel panel-flat">
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-6">
										<fieldset>
											<legend class="text-semibold"><i class="icon-reading position-left"></i> user credentials</legend>
											...
											<div class="form-group">
												...
												<select name="role"  data-placeholder="Select your state" class="select">
									...
									<div class="col-md-6">
										<fieldset>
						                	<legend class="text-semibold"><i class="icon-reading position-left"></i> Personal user details</legend>
											...
											<div class="row">
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<input type="text" name="lastname" placeholder="Kopyov" class="form-control">
													</div>
												</div>
											</div>
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														<label>Email:</label>
														<input type="email" name="email" placeholder="eugene@kopyov.com" class="form-control">
													</div>
												</div>
												...
												<div class="col-md-6">
													<div class="form-group">
														<label>Phone #:</label>
														<input type="number" name="phone" placeholder="+99-99-9999-9999" class="form-control">
													</div>
												</div>
											</div>
