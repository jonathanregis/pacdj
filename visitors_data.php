...
require('include/engine.php');
    ...
    ?>
						...
						<tr>
									...
									<td><a href="#"><?php echo ucwords($area_name);?></a></td>
									...
									<ul class="icons-list">
														<li class="dropdown">
															...
															<ul class="dropdown-menu dropdown-menu-right">
																<li><a href="#"><i class="icon-undo"></i> Assign</a></li>
																<li class="divider"></li>
																<li><a href="#"><i class="icon-history"></i> Edit</a></li>
																<li class="divider"></li>
																<li><a href="#"><i class="icon-checkmark3 text-success"></i> View</a></li>
																<li class="divider"></li>
