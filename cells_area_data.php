				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">View areas
							</span> 
							</h4>
						</div>
						...
						<div class="heading-elements">
							...
							<button type="button" class="btn bg-teal-400 btn-labeled" data-toggle="modal" data-target="#modal_form_add"><b><i class="icon-home"></i></b>Add Areas</button>
  ...
  <strong><?php echo $page_message_content;?></strong>
					...
					<h6 class="content-group text-semibold">
						<?php 
							...
							?>
						<small class="display-block">List of all the <?php 
							$pagename=basename($_SERVER['PHP_SELF']);
							$pagenameformated1= str_replace('.php', ' ', $pagename);
							$pagenameformated2= str_replace('_', ' ', $pagenameformated1);
							echo  ucwords("$pagenameformated2");
							?><code>recorded</code> </small>
					</h6>
					<!-- /basic tables title -->
		...
		<tr>
					...
					<td><a data-toggle="modal" data-target="#modal_form_edit" data-id="<?=$areaId;?>">edit</a>
					&nbsp;<a data-toggle="modal" data-target="#modal_form_delete" data-id="<?=$areaId;?>">delete</a></td>
							...
							<div class="modal-content">
								...
								<form action="php/add_area.php" method="post">
									...
									<div class="modal-footer">
										...
										<button type="submit" class="btn btn-primary" name="add_area">Submit form</button>
									</div>
								</form>
							</div>
						</div>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<form action="php/edit_area.php" method="post">
                                                                    <input type="hidden" name="areaId" class="id_input" value=""/>
									<div class="modal-body">
										<div class="form-group">
											<div class="row">
												<div class="col-sm-6">
													<label>Area Name</label>
													<input type="text" placeholder="Area name" name="area_name" class="form-control">
												</div>

												<div class="col-sm-6">
													<label>Area City</label>
													<input name="area_city" type="text" class="form-control">
												</div>
											</div>
										</div>

										<div class="form-group">
											<textarea name="area_desc" class="form-control" placeholder="Area description" rows="7"></textarea>
										</div>
									</div>

									<div class="modal-footer">
										<button type="button" class="btn btn-link" data-dismiss="modal">Close</button>
										<button type="submit" class="btn btn-primary" name="edit_area">Submit form</button>
									</div>
								</form>
							</div>
						</div>
...
<div id="modal_form_delete" class="modal fade">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<form action="php/del_area.php" method="post">
                                                                    <input type="hidden" name="areaId" class="id_input" value=""/>
									<div class="modal-body">
									...
									<div class="modal-footer">
										<button type="button" class="btn btn-link" data-dismiss="modal">Close</button>
										<button type="submit" class="btn btn-danger" name="delete_area">Delete</button>
									</div>
								</form>
							</div>
						</div>
